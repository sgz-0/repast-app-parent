...
public class OrderController {
    ...
    public List<OmsOrderAndShopInfoVo> selectOrderAndShop(@RequestParam("memberId")  Long memberId){
        return  orderListService.selectOrderAndShop(memberId);
    }
 ...
 */
    ...
    public  List<CartItemAndOrderVO> selectCartItemInfo(@RequestParam("memberId") Long memberId, @RequestParam("shopId") Long shopId){
        return cartItemAndOrderService.selectCartItemInfo(memberId,shopId);
    }
