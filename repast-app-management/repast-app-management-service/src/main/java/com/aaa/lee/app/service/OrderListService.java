...
public class OrderListService extends BaseService<OmsOrderAndShopInfoVo> {
     ...
     * @Date 2019/11/26
     */
    public List<OmsOrderAndShopInfoVo> selectOrderAndShop(Long memberId){
        List<OmsOrderAndShopInfoVo> orderAndShopInfo = omsOrderAndShopInfoVoMapper.getOrderAndShopInfo(memberId);
