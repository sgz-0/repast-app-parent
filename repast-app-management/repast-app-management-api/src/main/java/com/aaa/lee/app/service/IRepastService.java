...
public interface IRepastService {
    ...
    **/
    ...
    List<OrderInfo> getOrderById(@RequestParam("id") Long id);
    /**
     * @Author sgz
     * @Description
     * 根据订单的id获取订单的实付金额
     ...
     * @Throws
     **/
    @GetMapping("/getPayAmountByOrderId")
    BigDecimal getPayAmountByOrderId(Long id);

    /**
     * @Author sgz
     * @Description
     * 当支付成功之后给会员添加相应的积分和成长值
     * @Param
     * @Date 2019/11/23 1:41
     * @Return
     * @Throws
     **/
    @PutMapping("/updateIntegrationAndGrowth")

    int updateIntegrationAndGrowth(@RequestBody Member member);
}
